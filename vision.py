...
def run(args):
    ...
    imgs_to_keyp_model = ImagesToKeypEncoder(cfg, (4, 3, 128, 128), debug=True) #8, 3, 64, 64
    keyp_to_imgs_model = KeypToImagesDecoder(cfg, (4, 3, 128, 128), debug=True) #8, 3, 64, 64
    ...
    img = 0.5*torch.ones((1, 4, 3, 128, 128)) #1, 4, 3, 64, 64
