...
"""Data generation for the case of a single block lift in Sawyer Env"""
...
def get_frame(env, crop=(50,350), size=(128, 128)):
    frame = env.render(mode='dark_background').copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir_name", default='data/goal/sawyer_lift')
    parser.add_argument("--num_iter", type=int, default=5)
    parser.add_argument("--save_path", default="sawyer_lift_goal")
